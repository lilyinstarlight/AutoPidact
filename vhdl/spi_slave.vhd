...
BEGIN
  ...
  PROCESS(ss_n, clk, st_load_en, tx_load_en, tx_load_data, rx_req, rx_buf, rrdy, bit_cnt, st_load_trdy, st_load_rrdy, st_load_roe, reset_n, wr_add, rd_add)
  BEGIN
